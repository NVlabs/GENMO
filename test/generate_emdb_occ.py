...
if __name__ == "__main__":
    ...
    for vid in bar:
        ...
        for i in range(len(bbx_xys)):
            center, scale = rand_img_clip_transforms2(i, i, len(bbx_xys), kp2d.numpy(), bbx_cx.numpy(), 1)
        ...
        vitpose, imgs_dict = vitpose_extractor.extract(imgnames, occ_bbx_xys, img_ds=0.5, path_type="image_list")
