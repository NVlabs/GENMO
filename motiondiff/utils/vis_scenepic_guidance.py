    ...
    def generate_smpl_scene(self, smpl_seq=None, window_size=None, return_canvas=False, fps=30):
        ...
        for i, (skel_name, pose_dict) in enumerate(smpl_seq.items()):
            ...
            if 'joints_pos' in pose_dict:
                ...
                pose_dict['skeleton_jpos'] = SkeletonActor(scene, f'{skel_name}_jpos', self.smpl_joint_parents, joint_color=colors[0],
                ...
                if 'foot_contacts' in pose_dict:
                    pose_dict['foot_contacts_jpos'] = SkeletonActor(scene, f'{skel_name}_foot_contacts_jpos', self.smpl_joint_parents, joint_color='Red', bone_color='Yellow',
                ...
                if 'keyframes' in pose_dict:
                    ...
                    for key_name, keyframe_dict in pose_dict['keyframes'].items(): 
                        ...
                        skeleton_key_jpos = SkeletonActor(scene, f'{skel_name}_{key_name}', self.smpl_joint_parents, 
                        ...
                        if 'joint_inds' in keyframe_dict:
                            skeleton_key_jinds = SkeletonActor(scene, f'{skel_name}_{key_name}_joints', self.smpl_joint_parents, 
                                                            joint_color='Teal' if unknownt else 'Orange', 
                                                                bone_color='Purple' if unknownt else 'Yellow',
                ...
                if 'skeleton_jpos' in pose_dict:
                    ...
                    if 'foot_contacts' in pose_dict:
                        ...
                        if np.sum(cur_contacts) > 0:
                            foot_inds = np.array([7, 10, 8, 11]) # ("L_Ankle", "L_Toe", "R_Ankle", "R_Toe")
