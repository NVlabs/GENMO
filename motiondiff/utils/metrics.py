...
from motiondiff.data_pipeline.humanml.scripts.motion_process import recover_from_ric_264, recover_from_ric
...
class Metrics():
    def __init__(self, humanml_mean, humanml_std, humanml_global_mean, humanml_global_std,
    ...
    def preprocess(self, samples):
        ...
        if self.pred_samples_rep == 'global_root_local_joints':
            ...
            global_joint_pos, global_rot_quat = recover_from_ric_264(samples, 22, r_rot_quat=pred_r_rot_quat, r_pos=pred_r_pos)   
        elif self.pred_samples_rep == 'full263':
            global_joint_pos, global_rot_quat = recover_from_ric(samples, 22, return_r_rot=True)
