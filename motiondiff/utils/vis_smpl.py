...
class SMPLVisualizer(Visualizer3D):
    ...
    def __init__(self, smpl_model_dir=None, generator_func=None, device=torch.device('cpu'), show_smpl=True, show_skeleton=False, sample_visible_alltime=False, **kwargs):
