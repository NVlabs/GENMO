...
from motiondiff.data_pipeline.get_data import get_dataset, get_dataset_loader
...
parser.add_argument(
    "-o", "--out_file", default="data/stats/HumanML3D_global_pos_vel_stats.npy"
)
parser.add_argument(
    "-c", "--cfg", default="mdm_t5_enc_cat_len50_aug_amp2_b256_twostage_v2_vel"
)
...
for batch in dataloader:
    ...
    global_motion = (
        global_motion[:, :, 0]
        .permute(0, 2, 1)[..., : model.motion_root_dim]
        .reshape(-1, model.motion_root_dim)
    )
