...
f_not_bvh.close()
print(
    f"{missing_cnt} bvh files missing, {duplicate_cnt} duplicate bvh files, {wrong_folder_cnt} files not in BVH sub-folders, {not_bvh_cnt} files not ended with .bvh,  "
)
exit()
...
f_not_fbx.close()
print(
    f"{missing_cnt} fbx files missing, {duplicate_cnt} duplicate fbx files, {wrong_folder_cnt} files not in FBX sub-folders, {not_fbx_cnt} files not ended with .fbx,  "
)
