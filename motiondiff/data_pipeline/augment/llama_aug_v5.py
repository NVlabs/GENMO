...
prefix = \
"Answer the following questions DIRECTLY without any introduction, and start each answer with an asterisk (*). \
Each answer is one line. DO NOT use the asterisk (*) except at the start of an answer.\n"

preamble = \
"I will give you four descriptions that all describe the exact same human motion. \
...
part_paraphrase = 'Please use plain language and ' + post_details + \
...
part_command = 'Write the new descriptions as commands to the person and ' + post_details + \
"Here are few examples with only 3 outputs:\n \
Input:\n\
* reacting strongly to a kidney punch from the left side while in a fighting stance\n\
* exhibit a heavy reaction as if hit by a kidney punch from the left side\n\
...
part_brief_detail = 'Be as short and simple as possible but ' + post_details + \
"Here are few examples with only 3 outputs:\n \
Input:\n\
* person reaching down at a 45 degree angle towards an unattainable object on the floor with their left hand\n\
* trying to grasp something located far below on the floor with the left hand\n\
...
part_brief_command = 'Write the descriptions as commands and be as short and simple as possible, ' + post_details + \
"Here are few examples with only 3 outputs:\n \
Input:\n\
* person reaching down at a 45 degree angle towards an unattainable object on the floor with their left hand\n\
* trying to grasp something located far below on the floor with the left hand\n\
...
part_short = 'Be as short and simple as possible describing the MAIN action of the motion, ' + post_brief + \
"Here are few examples with only 3 outputs:\n \
Input:\n\
* person reaching down at a 45 degree angle towards an unattainable object on the floor with their left hand\n\
* trying to grasp something located far below on the floor with the left hand\n\
...
part_short_command = 'Describe the MAIN action of the motion as a command and be as short and simple as possible, ' + post_brief + \
"Here are few examples with only 3 outputs:\n \
Input:\n\
* person reaching down at a 45 degree angle towards an unattainable object on the floor with their left hand\n\
* trying to grasp something located far below on the floor with the left hand\n\
...
def paraphrase_text(text):
    try:
        ...
        if len(all_para_texts) != len(templates_arr) * NUM_EXPECTED:
            raise Exception('Not the expected number of paraphrases. Something is possibly wrong!')
