...
class ARMDMDenoiser(nn.Module):
    def __init__(self, pl_module, modeltype, njoints, nfeats, num_actions, translation, pose_rep, glob, glob_rot,
                 ...
                 ablation=None, activation="gelu", legacy=False, data_rep='rot', dataset='amass', llm_dim=512, max_text_len=20,
                 ...
                 use_precomp_text_embed=False, llm_embed_lmdb_path=None, **kargs):
        super().__init__()
    ...
    def forward(self, x, timesteps, y=None):
        ...
        if self.arch == 'trans_enc':
            ...
            output = self.seqTransEncoder(xseq, mask=src_mask)[pose_start_ind:]  # , src_key_padding_mask=~maskseq)  # [seqlen, bs, d]
