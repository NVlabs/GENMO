...
from hmr4d.camera import run_metric_slam, calibrate_intrinsics
...
cam_R, cam_T, all_scales, scale = run_metric_slam(img_folder, masks=masks, calib=cam_int, is_static=is_static)

camera = {'pred_cam_R': cam_R.numpy(), 'pred_cam_T': cam_T.numpy(), 
          'all_scales': all_scales, 'scale': scale,
