...
GT_feats = GT_feats.numpy().reshape(-1, feat_dim)
Pred_feats = Pred_feats.numpy().reshape(-1, feat_dim)

mu1, sigma1 = calculate_activation_statistics(GT_feats)
mu2, sigma2 = calculate_activation_statistics(Pred_feats)
