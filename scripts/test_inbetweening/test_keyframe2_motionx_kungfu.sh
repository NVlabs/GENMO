...
model_cfg.inpainting_3d.mode=body_pose_root_rot_keyframe2 test_datasets=[motionx_test] test_datasets.motionx_test.motion_start_mode=sample_early test_datasets.motionx_test.max_num_motions=256 +test_datasets.motionx_test.subset=[kungfu]
