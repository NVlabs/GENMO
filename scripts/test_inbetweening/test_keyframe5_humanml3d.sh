...
model_cfg.inpainting_3d.mode=body_pose_root_rot_keyframe5 +test_datasets.humanml3d_test.motion_start_mode=sample +test_datasets.humanml3d_test.use_random_subset=true +test_datasets.humanml3d_test.random_subset_size=128
...
model_cfg.inpainting_3d.mode=body_pose_root_rot_keyframe5 +test_datasets.humanml3d_test.motion_start_mode=sample +test_datasets.humanml3d_test.use_random_subset=true +test_datasets.humanml3d_test.random_subset_size=128 +rsync_ckpt=true
