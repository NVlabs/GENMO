...
model_cfg.inpainting_3d.mode=body_pose_root_rot_keyframe2 test_datasets=[motionx_test] test_datasets.motionx_test.motion_start_mode=sample test_datasets.motionx_test.max_num_motions=128
...
model_cfg.inpainting_3d.mode=body_pose_root_rot_keyframe2 remote_results_path=/lustre/fsw/portfolios/nvr/projects/nvr_torontoai_humanmotionfm/workspaces/motiondiff/motiondiff_results/jiefengl/gvhmr test_datasets=[motionx_test] test_datasets.motionx_test.motion_start_mode=sample test_datasets.motionx_test.max_num_motions=128
...
model_cfg.inpainting_3d.mode=body_pose_root_rot_keyframe2 test_datasets=[motionx_test] test_datasets.motionx_test.motion_start_mode=sample test_datasets.motionx_test.max_num_motions=128 +rsync_ckpt=true
