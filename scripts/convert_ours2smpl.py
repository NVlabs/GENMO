...
data_path = 'outputs/mocap_mixed_v1/unimfm/unimfm_test_st_g8/version_0/text_feats/feats.pt'
raw_data = torch.load(data_path).cuda()


smpl_data = encoder.decode_humanml3d(raw_data)

save_path = 'outputs/mocap_mixed_v1/unimfm/unimfm_test_st_g8/version_0/text_feats/feats_smpl.pt'
