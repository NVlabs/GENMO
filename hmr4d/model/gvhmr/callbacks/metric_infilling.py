...
class MetricInfilling(pl.Callback):
    def __init__(
        self,
        vis_every_n_val=10,
        save_feats=False,
    ...
    def on_predict_batch_end(
        ...
        for res_idx, out in enumerate(outputs):
            ...
            # Compute metrics
            keyframes = out["all_3d_keyframe_idx"][0]
            pred_kf_j3d_relative = (
                pred_j3d_can[keyframes[:]] - pred_j3d_can[keyframes[:], :1]
            )
            target_kf_j3d_relative = (
                target_j3d_can[keyframes[:]] - target_j3d_can[keyframes[:], :1]
            )
    ...
    def on_predict_epoch_end(self, trainer, pl_module):
        ...
        for metric_name in sorted(self.metrics):
            ...
            pl_module.logger.log_metrics(
                {f"metrics_infilling/{metric_name}": metric_avg},
