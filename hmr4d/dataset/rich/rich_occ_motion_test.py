...
class RichOccSmplFullSeqDataset(data.Dataset):
    def __init__(self, vid_presets=None):
        ...
        """
        super().__init__()
        self.dataset_name = "RICH-OCC"
        self.dataset_id = "RICH-OCC"
        ...
        self.preproc_data = torch.load(self.rich_dir / "rich_occ_test_preproc.pt")
    ...
    def _load_data(self, idx):
        ...
        length = end - start
        meta = {"dataset_id": "RICH-OCC", "vid": vid, "vid-start-end": (start, end)}
...
#
group_name = "test_datasets/rich_occ"
base_node = builds(RichOccSmplFullSeqDataset, vid_presets=None, populate_full_signature=True)
