...
class SMPLTransformerDecoderHead(nn.Module):
    ...
    def __init__(
        ...
        mean_params = np.load("inputs/checkpoints/vimo/smpl_mean_params.npz")
    ...
    def forward(self, x, only_return_token_out=False, **kwargs):
        ...
        return pred_pose, pred_shape, pred_cam, token_out


class temporal_attention(nn.Module):
    def __init__(
        self, in_dim=1280, out_dim=1280, hdim=512, nlayer=6, nhead=4, residual=False
    ):
