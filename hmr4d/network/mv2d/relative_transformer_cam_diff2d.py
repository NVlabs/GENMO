...
class NetworkEncoderRoPE(nn.Module):
    def __init__(
        ...
        self.learned_pos_params_3d = nn.Parameter(torch.randn(17, 32), requires_grad=True)
    ...
    def forward(self, length, obs=None, f_cliffcam=None, f_cam_angvel=None, f_imgseq=None, detach_j3d_for_mv2d=False, detach_cam_for_mv2d=False, proj_2d_cam=None, **kwargs):
        """
        Args:
        ...
        f_obs = f_obs * visible_mask + self.learned_pos_params_3d.repeat(B, L, 1, 1) * ~visible_mask
